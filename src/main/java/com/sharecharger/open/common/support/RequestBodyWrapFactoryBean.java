...
public class RequestBodyWrapFactoryBean implements WebMvcConfigurer {
    ...
    public RequestBodyWrapFactoryBean(GetEncryptData getEncryptData) {
    ...
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> list) {
        RequestBodyDecryptArgumentResolver decorator = new RequestBodyDecryptArgumentResolver(getEncryptData);
